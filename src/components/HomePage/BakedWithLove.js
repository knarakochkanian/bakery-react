        ...
        <section className='baked-with-love' >
            ...
            <div className='baked-with-love__cards'>
                <div className='baked-with-love__card'>
                    <img src='/assets/images/Home/cup.svg' alt='image' />
                    <img src='/assets/images/Home/BredsWithLove.png' className='baked-with-love__card-hover-img' alt='image' />
                ...
                <div className='baked-with-love__card'>
                    <img src='/assets/images/Home/tort.svg' alt='image' />
                    <img src='/assets/images/Home/BredsWithLove.png' className='baked-with-love__card-hover-img' alt='image' />
                ...
                <div className='baked-with-love__card'>
                    <img src='/assets/images/Home/breadswithlove.svg' alt='image' />
                    <img src='/assets/images/Home/BredsWithLove.png' className='baked-with-love__card-hover-img' alt='image' />
