    ...
    return (
        <section className='products'>
            ...
            <div className='products-grid-container'>
                <div className='products-grid-item item1'><img src='/assets/images/Home/product1.png' alt='product1'/>

                    </div>
                <div className='products-grid-item item2'>
                    <img src='/assets/images/Home/product2.png' alt='product2'/>
                ...
                <div className='products-grid-item item3'><img src='/assets/images/Home/product3.png' alt='product3'/>
                    <div className='products-grid-item__title'>Bakery</div>
                    <div className='products-grid-item__box'>
                ...
                <div className='products-grid-item item4'><img src='/assets/images/Home/product4.png' alt='product4'/>
                ...
                <div className='products-grid-item item5'><img src='/assets/images/Home/product5.png' alt='product5'/>
